...
require_once './blindmark_form.php';
...
$url = new moodle_url('/grade/report/marking/blindmark.php', array('courseid'=>$courseid));
if ($id !== 0) {
    $url->param('id', $id);
}
if ($itemid !== 0) {
...
$strmarkingreport = get_string('markingreport', 'gradereport_marking');
