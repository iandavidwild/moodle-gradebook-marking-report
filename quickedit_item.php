...
$url = new moodle_url('/grade/report/marking/quickedit_item.php', array('id'=>$courseid, 'itemid'=>$itemid));
if ($page !== 0) {
    $url->param('page', $page);
}
if ($perpage !== 0) {
...
$report = new grade_report_marking($courseid, $gpr, $context, $page);
...
$reportname = get_string('quickedititem', 'gradereport_marking', $a);
print_grade_page_head($COURSE->id, 'report', 'marking', $reportname);
