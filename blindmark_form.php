...
//-------------------------------------------------------------------------------
    ...
    function definition_after_data() {
        ...
        if ($user = $DB->get_record('user', array('id' => $userid))) {
        	// IDW 20/08/2012 Don't show a student's name... and don't create a link
        ...
        // IDW 20/08/2012... make that 'activity name + no link', as we want to make it harder for the marker to find out who they are marking 
        $itemname = $grade_item->get_name();
        $itemname_el =& $mform->getElement('itemname');
        $itemname_el->setValue($itemname);

        // Grade audit history link
